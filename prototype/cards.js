...
var NVU_CARDS = {
  ...
  cards: [
    ...
    {"name":"Second Wind","set":"proposed","kind":"player","owner":"Red","rarity":"Cool","cost":2,"oomph":4,"text":"Shuffle an exhausted Red card back into your deck."},
    ...
    {"name":"Deadweight Grip","set":"proposed","kind":"player","owner":"Red","rarity":"Woah","cost":1,"scramble":2,"hold":true,"text":"Holding: Cards you play have +1 Oomph, but you may not draw more than 2 cards per turn."},
    {"name":"Both Barrels","set":"proposed","kind":"player","owner":"Red","rarity":"Woah","cost":2,"oomph":4,"text":"If Gray has already played at least one card this turn, +2 Oomph. If this is the card that clears the room, put this right back in your hand."},
    ...
    {"name":"Hit 'n Run","set":"proposed","kind":"player","owner":"Gray","rarity":"Fine","cost":1,"oomph":2,"text":"Shuffle an exhausted Gray card back into your deck."},
    ...
    {"name":"I Know Kung Fu","set":"proposed","kind":"player","owner":"Gray","rarity":"Woah","cost":3,"oomph":5,"hold":true,"text":"Holding: when you play a card with Scramble, draw 1 card."},
    {"name":"Pry Bar","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"oomph":3,"hold":true},
    {"name":"Coil Of Cable","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"scramble":3,"hold":true},
    {"name":"Crowbar","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"oomph":1,"scramble":1,"hold":true,"text":"If you get any Good Stuff this turn, get an additional one."},
    ...
    {"name":"Cutting Torch","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":2,"oomph":5,"hold":true},
    {"name":"Grav Harness","set":"proposed","kind":"good_stuff","rarity":"Woah","cost":2,"oomph":3,"scramble":3,"hold":true,"text":"One of you draws 1 card, (even if their hand is full)."},
    ...
    {"name":"Overcharged Battery","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"oomph":2,"hold":true,"text":"The next card played this turn costs 0."},
    {"name":"Faceful Of Slime","set":"proposed","kind":"bad_stuff","cost":1,"hold":true,"text":"Holding: you may not draw more than 1 card per turn."},
    ...
    {"name":"Rust","set":"proposed","kind":"bad_stuff","cost":2,"hold":true,"text":"Holding: Stuff you play has -1 Oomph."},
