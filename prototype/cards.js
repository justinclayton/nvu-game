...
var NVU_CARDS = {
  ...
  cards: [
    ...
    {"name":"Zen Mode","set":"proposed","kind":"player","owner":"Red","rarity":"Woah","cost":0,"text":"While `Holding`, you don't Exhaust cards."},
    ...
    {"name":"A Pair Of Stich-Em-Ups","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"text":"Move 2 cards from your exhaust pile to the bottom of your deck."},
    ...
    {"name":"Riot Shield","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"scramble":3,"text":"At the end of turn, return this card to your hand."},
    ...
    {"name":"Faceful Of Slime","set":"proposed","kind":"bad_stuff","cost":1,"text":"Holding: you may not draw more than 1 card per turn."},
