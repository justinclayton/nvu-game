...
var NVU_CARDS = {
  ...
  cards: [
    ...
    {"name":"Gross Thing That Looks Like A Cherry","set":"proposed","kind":"stairwell","band":1,"thresholds":[{"stat":"Oomph","value":5,"outcome":"Ascend"}],"flee":"Both of you Exhaust 1."},
    {"name":"Coney, The Thing In The Stairwell","set":"proposed","kind":"stairwell","band":1,"thresholds":[{"stat":"Oomph","value":9,"outcome":"Ascend"}],"flee":"Both of you Exhaust 1."},
    {"name":"Villy, Coney's Work Husband","set":"proposed","kind":"stairwell","band":1,"thresholds":[{"stat":"Oomph","value":9,"outcome":"Ascend"},{"stat":"Scramble","value":9,"outcome":"Flee this room for free."}],"flee":"Both of you Exhaust 2."},
    {"name":"Collapsed Stairwell","set":"proposed","kind":"room","band":1,"thresholds":[{"stat":"Scramble","value":2,"outcome":"Clear, but both of you Exhaust 1."},{"stat":"Scramble","value":5,"outcome":"Clear, and one of you reveals a reward."}],"flee":"One of you Exhausts 3.","count":3},
    {"name":"Ruptured Coolant Line","set":"proposed","kind":"room","band":1,"thresholds":[{"stat":"Scramble","value":4,"outcome":"Clear, but both of you get Bad Stuff."},{"stat":"Scramble","value":7,"outcome":"Clear, and one of you reveals a reward."}],"flee":"Both of you Exhaust 1, and one of you gets Bad Stuff.","count":3},
    {"name":"Sorting Room","set":"proposed","kind":"room","band":1,"thresholds":[{"stat":"Oomph","value":2,"outcome":"Red gets Good Stuff."},{"stat":"Scramble","value":2,"outcome":"Gray gets Good Stuff."}],"count":3},
    {"name":"Ration Locker","set":"proposed","kind":"room","band":1,"thresholds":[{"stat":"Oomph","value":2,"outcome":"Red gets Good Stuff."},{"stat":"Scramble","value":2,"outcome":"Gray gets Good Stuff."},{"stat":"Oomph","value":4,"outcome":"Red gets 2 instead."},{"stat":"Scramble","value":4,"outcome":"Gray gets 2 instead."}],"count":2},
    {"name":"Tool Cage","set":"proposed","kind":"room","band":1,"thresholds":[{"stat":"Scramble","value":3,"outcome":"Both of you get Good Stuff."},{"stat":"Oomph","value":5,"outcome":"Red gets 2 instead."}],"count":2},
    {"name":"Spill Of Cargo","set":"proposed","kind":"room","band":1,"thresholds":[{"stat":"Scramble","value":3,"outcome":"Both of you get Good Stuff."},{"stat":"Scramble","value":5,"outcome":"Gray gets 2 instead."}],"count":2}
  ]
};
