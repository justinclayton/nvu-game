...
var NVU_CARDS = {
  ...
  cards: [
    ...
    {"name":"Set 'Em Up","set":"proposed","kind":"player","owner":"Red","rarity":"Fine","cost":1,"oomph":2,"scramble":1,"flavor":"Clear the heavy debris so Gray can maneuver effortlessly.","text":"Play: The next card Gray plays this turn gains +2 Scramble.","count":2},
    ...
    {"name":"Quick Vault","set":"proposed","kind":"player","owner":"Gray","rarity":"Fine","cost":1,"oomph":1,"scramble":2,"flavor":"Spring off Red's shoulder to clear the gap.","count":2},
    {"name":"In Step","set":"proposed","kind":"player","owner":"Gray","rarity":"Cool","cost":1,"conditional_stat":true,"flavor":"Sync your movements perfectly with Red's brute rhythm.","text":"Scramble equal to 2 times the number of cards Red has played this turn.","count":2},
    {"name":"One Man's Junk","set":"proposed","kind":"player","owner":"Gray","rarity":"Cool","cost":1,"oomph":2,"scramble":2,"flavor":"Turn hazardous junk into a makeshift advantage.","text":"If any Bad Stuff is played this turn, gain Oomph +1 and Scramble +1.","count":2},
    ...
    {"name":"A Pair Of Stitch-Em-Ups","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"flavor":"Field-grade medical staples to restore lost Stamina.","text":"Choose a character. Move 2 cards from that character's Exhaust pile to the bottom of their deck.","count":3},
    {"name":"High-Frequency Scanner","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"scramble":3,"flavor":"Pings upcoming hazards before you step into the room.","text":"Play: Look at the top 3 cards of the Floor deck.","count":3},
    {"name":"Scrap Magnet","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"flavor":"A heavy electromagnetic tool that pulls toxic shrapnel right out of your pack.","text":"Play: Scrap 1 Bad Stuff card from your hand. If you do, gain 2 Oomph or 2 Scramble.","count":3},
    {"name":"Pocket Dynamo","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"flavor":"A hand-cranked generator that charges when team tempo builds.","text":"Play: Draw 1 card. If both you and your partner played a card this turn, gain 1 Oomph and 1 Scramble.","count":3},
    {"name":"Salvaged Blueprint","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"scramble":2,"flavor":"Quick tactical schematic that reorganizes upcoming options.","text":"Play: Draw 2 cards, then place 1 card from your hand on top of your deck.","count":2},
    {"name":"Emergency Breaker","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"oomph":2,"scramble":2,"flavor":"Shatter a jammed valve to clear your pack and open a window for your partner.","text":"Play: Scrap 1 card from your hand. Your partner draws 1 card.","count":2},
    ...
    {"name":"Torn Seal","set":"proposed","kind":"bad_stuff","cost":3,"flavor":"Broken rubber gasket. Useless dead weight clogging your pack.","text":null,"count":2},
    {"name":"Sluggish","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Limb fatigue slows down every movement.","text":"Holding: Cards you play cost +1 card to play.","count":2},
    {"name":"Rust","set":"proposed","kind":"bad_stuff","cost":3,"flavor":"Corrosion degrades the quality of your scavenged gear.","text":"Holding: Stuff cards you play have -1 Oomph and -1 Scramble.","count":2},
    {"name":"Faceful Of Slime","set":"proposed","kind":"bad_stuff","cost":3,"flavor":"Murky goop blinds your vision and slows drawing.","text":"Holding: At Turn Start, draw 1 fewer card.","count":2},
    {"name":"Spore Cloud","set":"proposed","kind":"bad_stuff","cost":3,"flavor":"Choking spores force you to drop excess gear.","text":"Holding: At Cleanup, discard cards other than this one until you hold 3.","count":2},
    {"name":"My Head Is Quantum Spinning","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Disorientation drains stamina whenever team communication spikes.","text":"Holding: Whenever your partner draws a card during Play, Exhaust 1.","count":2},
    {"name":"Panic","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Blinding fear raises room difficulty and drains team stamina.","text":"Holding: Every room threshold requires +2 Scramble to be met. Play: Exhaust 2.","count":2},
    {"name":"Corrosive Acid","set":"proposed","kind":"bad_stuff","cost":3,"flavor":"Caustic fluid eats away at your deck stamina and gear.","text":"Holding: At Turn Start, Exhaust 1. Play: Scrap 1 Good Stuff card from your hand.","count":2},
    {"name":"System Feedback","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Electrical backlash dampens cheap card plays.","text":"Holding: Whenever you play a card with Cost 0, lose 1 Oomph and 1 Scramble from the Stat pool this turn.","count":2},
    {"name":"Security Turnstile","set":"proposed","kind":"room","band":1,"flavor":"A rusted barrier blocks the thoroughfare. You can slip through quietly or tear it off its hinges.","challenges":[{"thresholds":[{"stat":"Scramble","value":3,"outcome":"Clear."}]},{"thresholds":[{"stat":"Oomph","value":5,"outcome":"Clear, and Red gets Good Stuff, but both players Exhaust 1."}]}],"flee":"Both players Exhaust 1.","count":14},
    {"name":"Flooded Ventilation Shaft","set":"proposed","kind":"room","band":1,"flavor":"A narrow duct dripping with murky condensation. Red can force the grate while Gray navigates the wiring.","challenges":[{"thresholds":[{"stat":"Scramble","value":4,"outcome":"Clear."}]},{"thresholds":[{"stats":{"Oomph":3,"Scramble":3},"outcome":"Clear, and both players get Good Stuff."}]}],"flee":"Gray Exhausts 2.","count":10},
    {"name":"The Sentry Drone","set":"proposed","kind":"stairwell","band":1,"flavor":"An automated defense unit guarding the stairwell. Destroy its chassis or cut its power harness.","challenges":[{"thresholds":[{"stat":"Oomph","value":6,"outcome":"Ascend."}]},{"thresholds":[{"stat":"Scramble","value":6,"outcome":"Ascend."}]},{"thresholds":[{"stats":{"Oomph":4,"Scramble":4},"outcome":"Ascend, and both players get 2 Good Stuff!"}]}],"flee":"Both players Exhaust 1, and both players get Bad Stuff.","count":3},
    {"name":"Automated Defense Turret","set":"proposed","kind":"room","band":2,"flavor":"A heavy turretted cannon sweeps the corridor. Deactivating its targeting sensors requires precision; smashing it requires brute force.","challenges":[{"thresholds":[{"stat":"Scramble","value":8,"outcome":"Clear, and Gray gets Good Stuff."}]},{"thresholds":[{"stat":"Oomph","value":10,"outcome":"Clear, and one of you may Scrap a Bad Stuff card from your hand."}]}],"flee":"Both players Exhaust 2, and both players get Bad Stuff.","count":7},
    {"name":"Pressurized Maintenance Hub","set":"proposed","kind":"room","band":2,"flavor":"High-pressure steam pipes obstruct the gangway. Red must brace the valves while Gray hacks the overrides.","challenges":[{"thresholds":[{"stat":"Oomph","value":7,"outcome":"Clear, and Red reveals a card reward."}]},{"thresholds":[{"stat":"Scramble","value":7,"outcome":"Clear, and Gray reveals a card reward."}]}],"flee":"Both players Exhaust 2.","count":4},
    {"name":"Overgrown Hydroponics Bay","set":"proposed","kind":"room","band":2,"flavor":"Mutated flora fills the chamber, emitting dense spore clouds.","challenges":[{"thresholds":[{"stat":"Scramble","value":6,"outcome":"Clear, but both players get Bad Stuff."},{"stat":"Scramble","value":11,"outcome":"Clear, and both players get Good Stuff."}]}],"flee":"Both players Exhaust 2, and Gray gets Bad Stuff.","count":4},
    {"name":"Gears & Glitch","set":"proposed","kind":"stairwell","band":2,"flavor":"A pair of rogue maintenance constructs blocking the stairwell door.","challenges":[{"thresholds":[{"stat":"Oomph","value":12,"outcome":"Ascend."}]},{"thresholds":[{"stats":{"Oomph":7,"Scramble":7},"outcome":"Ascend, and one of you reveals a card reward."}]}],"flee":"Both players Exhaust 3, and Red gets Bad Stuff.","count":3},
    {"name":"Laser Grid Security Hall","set":"proposed","kind":"room","band":3,"flavor":"Interlocking laser beams cover every inch of the floor. Slip through without touching a beam, or shatter the emitter relay.","challenges":[{"thresholds":[{"stat":"Scramble","value":14,"outcome":"Clear, and Gray reveals a card reward."}]},{"thresholds":[{"stat":"Oomph","value":18,"outcome":"Clear, but both players Exhaust 2."}]}],"flee":"Both players Exhaust 4.","count":2},
    {"name":"Bio-Hazard Containment Vault","set":"proposed","kind":"room","band":3,"flavor":"A sealed vault holding experimental equipment. The door control requires an energy surge.","challenges":[{"thresholds":[{"stat":"Oomph","value":15,"outcome":"Clear, and one of you reveals a card reward."}]},{"thresholds":[{"stat":"Scramble","value":15,"outcome":"Clear, and one of you reveals a card reward."}]}],"flee":"Both players get 2 Bad Stuff, and both players Exhaust 2.","text":"Players may Scrap Good Stuff cards from their hand during Play to add +3 Oomph or +3 Scramble per card.","count":2},
    {"name":"Smoldering Armory","set":"proposed","kind":"room","band":3,"flavor":"An overheating weapons cache on the verge of exploding.","challenges":[{"thresholds":[{"stat":"Oomph","value":10,"outcome":"Clear, and Red gets Good Stuff."},{"stat":"Oomph","value":16,"outcome":"Clear; both players reveal a card reward, and both players get Good Stuff."}]}],"flee":"Red Exhausts 5.","count":2},
    {"name":"The Iron Sentinel","set":"proposed","kind":"stairwell","band":3,"flavor":"The massive titan guarding the doorway to the upper tower.","challenges":[{"thresholds":[{"stats":{"Oomph":10,"Scramble":10},"outcome":"Ascend, and both players reveal a card reward."}]},{"thresholds":[{"stat":"Oomph","value":18,"outcome":"Ascend, but both players Exhaust 3."}]}],"flee":"Both players Exhaust 4, and both players get Bad Stuff.","count":3},
    {"name":"The Monolith Core","set":"proposed","kind":"stairwell","band":null,"flavor":"The central nexus at the apex of Pyramid Tower. It radiates crackling energy.","challenges":[{"thresholds":[{"stats":{"Oomph":10,"Scramble":10},"outcome":"You Win!"}]},{"thresholds":[{"stat":"Oomph","value":22,"outcome":"You Win!"}]}],"flee":"Both players Exhaust 5."}
  ]
};
