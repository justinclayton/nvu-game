...
var NVU_CARDS = {
  ...
  cards: [
    ...
    {"name":"Junk Launcher","set":"proposed","kind":"player","owner":"Red","rarity":"Cool","cost":2,"conditional_stat":true,"flavor":"Hurl whatever scrap isn't nailed down.","text":"Oomph equal to total costs of all cards you played this turn.","count":2},
    ...
    {"name":"Security Turnstile","set":"proposed","kind":"room","band":1,"flavor":"A rusted barrier blocks the thoroughfare. You can slip through quietly or tear it off its hinges.","challenges":[{"thresholds":[{"stat":"Scramble","value":3,"outcome":"Clear."}]},{"thresholds":[{"stat":"Oomph","value":5,"outcome":"Clear, and Red gets Good Stuff, but both of you Exhaust 1."}]}],"flee":"Both of you Exhaust 1.","count":14},
    {"name":"Flooded Ventilation Shaft","set":"proposed","kind":"room","band":1,"flavor":"A narrow duct dripping with murky condensation. Red can force the grate while Gray navigates the wiring.","challenges":[{"thresholds":[{"stat":"Scramble","value":4,"outcome":"Clear."}]},{"thresholds":[{"stats":{"Oomph":3,"Scramble":3},"outcome":"Clear, and Gray gets Good Stuff."}]}],"flee":"Gray Exhausts 2.","count":10},
