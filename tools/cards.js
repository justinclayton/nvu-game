...
var NVU_CARDS = {
  ...
  cards: [
    ...
    {"name":"Pry Bar","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"oomph":3,"flavor":"Simple, solid steel. Good for prying open grates or cracking skulls."},
    {"name":"Coil Of Cable","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"scramble":3,"flavor":"High-tensile wire. Essential for rigging quick bypasses."},
    {"name":"Crowbar","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"oomph":1,"scramble":1,"flavor":"Versatile tool that helps pop open supply crates.","text":"Play: If you get any Good Stuff this turn, get 1 additional Good Stuff."},
    {"name":"Duct Tape & Wire","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":1,"oomph":2,"scramble":2,"flavor":"Quick repairs that surprisingly hold together under pressure."},
    {"name":"Stim Pack","set":"proposed","kind":"good_stuff","rarity":"Fine","cost":0,"oomph":2,"flavor":"Adrenaline surge to keep moving when stamina is low.","text":"Play: Draw 1 card."},
    {"name":"Cutting Torch","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":2,"oomph":5,"flavor":"Burns through reinforced bulkheads in seconds."},
    {"name":"Riot Shield","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"scramble":3,"flavor":"Heavy poly-carb barrier that survives multiple engagements.","text":"If the room is Cleared, return this card to your hand at the end of the turn."},
    {"name":"Overcharged Battery","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"oomph":2,"scramble":1,"flavor":"Sparks fly as raw current surges through your gear.","text":"The next card played this turn is played for free."},
    {"name":"A Pair Of Stitch-Em-Ups","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"flavor":"Field-grade medical staples to restore lost Stamina.","text":"Choose a character. Move 2 cards from that character's Exhaust pile to the bottom of their deck."},
    {"name":"High-Frequency Scanner","set":"proposed","kind":"good_stuff","rarity":"Cool","cost":1,"scramble":3,"flavor":"Pings upcoming hazards before you step into the room.","text":"Play: Look at the top 3 cards of the Floor deck."},
    ...
    {"name":"Torn Seal","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Broken rubber gasket. Useless dead weight clogging your pack.","text":null},
    {"name":"Sluggish","set":"proposed","kind":"bad_stuff","cost":1,"flavor":"Limb fatigue slows down every movement.","text":"Holding: Cards you play cost +1 card to play."},
    {"name":"Rust","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Corrosion degrades the quality of your scavenged gear.","text":"Holding: Stuff cards you play have -1 Oomph and -1 Scramble."},
    {"name":"Faceful Of Slime","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Murky goop blinds your vision and slows drawing.","text":"Holding: At Turn Start, draw 1 fewer card."},
    {"name":"Spore Cloud","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Choking spores force you to drop excess gear.","text":"Holding: At Cleanup, discard cards other than this one until you hold 3."},
    {"name":"My Head Is Quantum Spinning","set":"proposed","kind":"bad_stuff","cost":1,"flavor":"Disorientation drains stamina whenever team communication spikes.","text":"Holding: Whenever your partner draws a card during Play, Exhaust 1."},
    {"name":"Panic","set":"proposed","kind":"bad_stuff","cost":1,"flavor":"Blinding fear raises room difficulty and drains team stamina.","text":"Holding: Every room threshold requires +2 Scramble to be met. Play: Exhaust 2."},
    {"name":"Corrosive Acid","set":"proposed","kind":"bad_stuff","cost":2,"flavor":"Caustic fluid eats away at your deck stamina and gear.","text":"Holding: At Turn Start, Exhaust 1. Play: Scrap 1 Good Stuff card from your hand."},
    {"name":"System Feedback","set":"proposed","kind":"bad_stuff","cost":1,"flavor":"Electrical backlash dampens cheap card plays.","text":"Holding: Whenever you play a card with Cost 0, lose 1 Oomph and 1 Scramble from the Stat pool this turn."},
    ...
    {"name":"The Sentry Drone","set":"proposed","kind":"stairwell","band":1,"flavor":"An automated defense unit guarding the stairwell. Destroy its chassis or cut its power harness.","challenges":[{"thresholds":[{"stat":"Oomph","value":8,"outcome":"Ascend."}]},{"thresholds":[{"stat":"Scramble","value":8,"outcome":"Ascend, and one of you gets Good Stuff."}]}],"flee":"Both of you Exhaust 1, and Red gets Bad Stuff."},
    ...
    {"name":"Gears & Glitch","set":"proposed","kind":"stairwell","band":2,"flavor":"A pair of rogue maintenance constructs blocking the stairwell door.","challenges":[{"thresholds":[{"stat":"Oomph","value":12,"outcome":"Ascend."}]},{"thresholds":[{"stats":{"Oomph":7,"Scramble":7},"outcome":"Ascend, and one of you reveals a card reward."}]}],"flee":"Both of you Exhaust 3, and Red gets Bad Stuff."},
